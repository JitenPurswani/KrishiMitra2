                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li>
                        <a href="/crop-recommendation" className="hover:underline">
                          Crop Recommendation
                        </a>
                      </li>
                      <li>
                        <a href="/organic-farming" className="hover:underline">
                          Organic Farming
                        </a>
                      </li>
                      <li>
                        <a href="/government-schemes" className="hover:underline">
                          Government Schemes
                        </a>
                      </li>
                      <li>
                        <a href="/crop-rotation" className="hover:underline">
                          Crop Rotation
                        </a>
                      </li>
                    </ul>
